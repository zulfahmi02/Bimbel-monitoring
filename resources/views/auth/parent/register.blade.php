...
<div class="min-h-screen flex items-center justify-center relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative z-10 max-w-md w-full">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 space-y-6">
            ...
            <!-- Register Form -->
            <form class="space-y-4" action="{{ route('parent.register') }}" method="POST" x-data="{ loading: false, password: '', passwordStrength: 0, showPassword: false, showConfirmPassword: false }" @submit="loading = true">
                @csrf
            ...
            <div class="text-center pt-4 border-t border-gray-200">
                <p class="text-sm text-gray-600">
                    Sudah punya akun? 
                    <a href="{{ route('parent.login') }}" class="font-semibold text-green-600 hover:text-green-700 transition">
                        Login Disini
                    </a>
                </p>
            </div>
