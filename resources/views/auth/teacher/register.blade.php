    ...
    <div class="relative z-10 max-w-md w-full">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 space-y-6">
            <div class="text-center">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Pendaftaran Guru</h2>
                <p class="mt-2 text-sm text-gray-600">Bergabung untuk membuat media pembelajaran interaktif</p>
            </div>

            <!-- Register Form -->
            <form class="space-y-4" action="{{ route('teacher.register') }}" method="POST" x-data="{ loading: false, password: '', passwordStrength: 0, showPassword: false, showConfirmPassword: false }" @submit="loading = true">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            value="{{ old('name') }}"
                            class="block w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-white/50 backdrop-blur-sm" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="block w-full pl-12 pr-12 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-white/50 backdrop-blur-sm" 
                    ...
                    <div class="mt-2 flex gap-1">
                        <div class="h-1 flex-1 rounded-full" :class="passwordStrength >= 1 ? (passwordStrength === 1 ? 'bg-red-500' : passwordStrength === 2 ? 'bg-yellow-500' : 'bg-green-500') : 'bg-gray-200'"></div>
                        <div class="h-1 flex-1 rounded-full" :class="passwordStrength >= 2 ? (passwordStrength === 2 ? 'bg-yellow-500' : 'bg-green-500') : 'bg-gray-200'"></div>
            ...
            <div class="text-center pt-4 border-t border-gray-200">
                <p class="text-sm text-gray-600">
                    Sudah punya akun? 
                    <a href="{{ route('teacher.login') }}" class="font-semibold text-blue-600 hover:text-blue-700 transition">
                        Login Disini
                    </a>
                </p>
            </div>
        ...
        <p class="mt-6 text-center text-xs text-gray-500">
            Dengan mendaftar, Anda menyetujui <a href="#" class="underline hover:text-gray-700">Syarat & Ketentuan</a> kami
        </p>
    </div>
</div>
