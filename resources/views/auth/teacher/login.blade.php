...
<div class="min-h-screen flex items-center justify-center relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative z-10 max-w-md w-full">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 space-y-6">
            ...
            <!-- Login Form -->
            <form class="space-y-5" action="{{ route('teacher.login') }}" method="POST" x-data="{ loading: false, showPassword: false }" @submit="loading = true">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('landing') }}" class="text-sm font-medium text-blue-600 hover:text-blue-700 transition">
                        Kembali ke Home
                    </a>
                </div>
            ...
            <div class="text-center pt-4 border-t border-gray-200">
                <p class="text-sm text-gray-600">
                    Belum punya akun? 
                    <a href="{{ route('teacher.register') }}" class="font-semibold text-blue-600 hover:text-blue-700 transition">
                        Daftar Sekarang
                    </a>
                </p>
            </div>
