...
<head>
    ...
    <style>
        ...
        .score-box { text-align: center; margin: 20px 0; padding: 20px; background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; }
        .score-value { font-size: 48px; font-weight: bold; color: #166534; }
        .score-label { font-size: 14px; color: #166534; text-transform: uppercase; }
        .info-table { width: 100%; margin-bottom: 20px; border-collapse: collapse; }
        .info-table td { padding: 5px; }
        .answer-list { margin-top: 30px; }
        .question-item { margin-bottom: 15px; page-break-inside: avoid; border-bottom: 1px solid #eee; padding-bottom: 15px; }
        .question-text { font-weight: bold; margin-bottom: 5px; }
        .answer-status { font-size: 12px; font-weight: bold; padding: 2px 6px; border-radius: 4px; display: inline-block; margin-left: 10px; }
